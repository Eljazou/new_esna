      ...
      <div class="col-12 text-center">
        ...
        if (count($visiteencour) == 0)
          ...
          if ($client["Client"]["id"] == $visiteencour["Visite"]["client_id"]) {
            ...
            <a href="javascript:void(0)" class="btn_spiner btn btn-primary button-footer btn_viewclient" id="<?php echo $visiteencour["Client"]["id"]; ?>">Remplir rapport de : <?php echo $visiteencour["Client"]["nom"]; ?> </a>
          <?php }
        }
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('.btn_viewclient').on('click', function(event) {
			sendToReactApp(event.currentTarget.id);
		});
  });
