                ...
                <div class="box-body no-padding  form-horizontal payment-form">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                            ...
                            <h4 class=" box-title col-md-12 col-sm-12 col-xs-12" style="padding:0;">Type de pharmacie <sup style="color:red;">*</sup></h4></div>
                            <div class="for-pad">
                        ...
                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;" >
                            <div class="box-header with-border">
                            <h4 class="box-title col-md-12 col-sm-12 col-xs-12" style="padding:0;">Activité de pharmacie <sup style="color:red;">*</sup></h4></div>
                            <div class="for-pad">
                        ...
                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                            <div class="box-header with-border">
                            <h4 class="box-title col-md-12 col-sm-12 col-xs-12" style="padding:0;">Nombre de boites vendues/semaine </h4></div>
                            <div class="for-pad">
                            <span class="col-md-4 col-sm-4 col-xs-4 text-center" >
                        ...
                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                            ...
                            <div style="  padding: 10px 0px; margin-top: 0px; display: block;" class="col-xs-12 concur<?php echo $i ?> concure">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12 no-padding">
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12 no-padding">
                                        <?php echo $this->Form->input("Visite.objection.$i.stock", array("class"=>"VisiteObjectionStock","label" => false, 'placeholder' => "Stock disponible au moment de la visite", "type" => "number","style" => "margin-top:2px;width: 100%;")); ?>
                                    </div>
                                
                            </div>
                        </div>

                        <?php endfor; for($i=2;$i<4;$i++):
                            ...
                            <div style="padding: 10px 0px; margin-top: 0px; display: block;" class="col-xs-12 concur<?php echo $i ?> concure">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 no-padding" >
                                    ...
                                    <span class="col-md-6 col-sm-12 col-xs-12 check0 no-padding">
                                        <?php echo $this->Form->input("Visite.concurrence_p.$i.produitconcurant", array("label" => false, 'placeholder' => "Produit concurant","style" => "width:100%")); ?>
                                    </span>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="padding-top: 14px;">
                                    ...
                                    <span class="col-md-8 col-sm-12 col-xs-12" style="padding-left: 18px;">
                                        <span class="col-md-4 col-sm-12 col-xs-12">
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][offre]" class="mc3 col-md-4 col-sm-4 col-xs-4" 
                                                   value="Pack" style="margin: 2px;padding: 0px 2px;width: 30%;">
                                            <b style="font-weight:normal;"> Pack </b>
                                        </span>
                                        <span class="col-md-4 col-sm-12 col-xs-12">
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][offre]" class="mc3 col-md-4 col-sm-4 col-xs-4"
                                                   value="Action" style="margin: 2px;padding: 0px 2px;width: 30%;">
                                            <b style="font-weight:normal;"> Action </b>
                                        </span>
                                        <span class="col-md-4 col-sm-12 col-xs-12" >
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][offre]" class="mc3 col-md-4 col-sm-4 col-xs-4" 
                                                   value="Autres" style="margin: 2px;padding: 0px 2px;width: 30%;">
                                            <b style="font-weight:normal;"> Autres </b>
                                        </span>
                                    </span>
                                    </div>
                                    <div class="col-md-12 no-padding" style="padding-top: 14px;">
                                    <span class="col-md-3 col-sm-12 col-xs-12 check3" style="margin-bottom: 10px;">
                                        <b style="font-weight: 600;">Degré d'agressivité</b>
                                    </span>
                                    <span class="col-md-9 col-sm-12 col-xs-12" >
                                        <span class="col-md-4 col-sm-12 col-xs-12">
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][agressivite]" class="mc3 col-md-4 col-sm-4 col-xs-4"
                                                   value="Tres agressive" style="margin: 2px;padding: 0px 2px;width: 30%;">
                                            <b style="font-weight:normal;"> Tres agressive </b>
                                        </span>
                                        <span class="col-md-4 col-sm-12 col-xs-12">
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][agressivite]" class="mc3 col-md-4 col-sm-4 col-xs-4" 
                                                   value="Agressive" style="margin: 2px;padding: 0px 2px;width: 30%;">
                                            <b style="font-weight:normal;"> Agressive </b>
                                        </span>
                                        <span class="col-md-4 col-sm-12 col-xs-12">
                                            <input type="radio" name="data[Visite][concurrence_p][<?php echo $i; ?>][agressivite]" class="mc3 col-md-4 col-sm-4 col-xs-4" 
                                                   value="Peu agressive" style="margin: 2px;padding: 0px 2px;width: 30%;">
