...
<div class="row">
    <div class="col-md-12" style="margin-bottom: 20px;">
        <a href="<?php echo $this->Html->url(array('action' => 'index')); ?>" class="btn btn-light btn-no-print"><i class="ki-duotone ki-arrow-left"><span class="path1"></span><span class="path2"></span></i> Retour à l'historique</a>
        <button onclick="window.print();" class="btn btn-primary float-end btn-no-print"><i class="ki-duotone ki-printer"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> Télécharger / Imprimer</button>
    </div>

    <div class="col-md-12">
        <div class="card box-solid report-card">
            <div class="card-body">
                ...
                <div class="block-header">BLOC 1 : PRÉPARATION ET PRÉSENTATION DES VISITES <span class="float-end">MOYENNE: <?php echo $evaluation['Evaluation']['score_b1']; ?> / 4</span></div>
                ...
                <div class="block-header" style="margin-top: 20px;">BLOC 2 : TECHNIQUE DE VENTE ET DE COMMUNICATION <span class="float-end">MOYENNE: <?php echo $evaluation['Evaluation']['score_b2']; ?> / 4</span></div>
                <table class="report-table">
                ...
                <div class="block-header" style="margin-top: 20px;">BLOC 3 : ENGAGEMENT ET ANALYSE POST-VISITES <span class="float-end">MOYENNE: <?php echo $evaluation['Evaluation']['score_b3']; ?> / 4</span></div>
                <table class="report-table">
                ...
                <div class="row btn-no-print" style="margin-top: 30px;">
                    ...
                    <div class="col-md-12" style="margin-bottom: 20px;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card" style="border-top-width: 3px; border-radius: 8px;">
                                    <div class="card-header">
                                        <h3 class="card-title" style="color: #00a65a; font-weight: bold;"><i class="ki-duotone ki-like"><span class="path1"></span><span class="path2"></span></i> Top 3 Forces</h3>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-unstyled" style="font-size: 14px; line-height: 2;">
                                            <?php foreach($topForces as $label => $score): ?>
                                                <li><i class="ki-duotone ki-check text-success" style="margin-right: 10px;"></i> <strong><?php echo $label; ?></strong> <span class="float-end text-muted"><?php echo $score; ?>/4</span></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card" style="border-top-width: 3px; border-radius: 8px;">
                                    <div class="card-header">
                                        <h3 class="card-title" style="color: #dd4b39; font-weight: bold;"><i class="ki-duotone ki-information-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i> Top 3 Axes d'amélioration</h3>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-unstyled" style="font-size: 14px; line-height: 2;">
                                            <?php foreach($topAxes as $label => $score): ?>
                                                <li><i class="ki-duotone ki-arrow-down text-danger" style="margin-right: 10px;"><span class="path1"></span><span class="path2"></span></i> <strong><?php echo $label; ?></strong> <span class="float-end text-muted"><?php echo $score; ?>/4</span></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <!-- Graphics -->
                    <div class="col-md-6">
                        <div class="card box-solid" style="border: 1px solid #eee; border-radius: 8px;">
                            <div class="card-header" style="background: #fafafa;">
                                <h3 class="card-title" style="font-size: 14px; font-weight: bold;"><i class="ki-duotone ki-chart-pie-simple" style="color: #3c8dbc;"><span class="path1"></span><span class="path2"></span></i> Profil de Visite (Radar)</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card box-solid" style="border: 1px solid #eee; border-radius: 8px;">
                            <div class="card-header" style="background: #fafafa;">
                                <h3 class="card-title" style="font-size: 14px; font-weight: bold;"><i class="ki-duotone ki-chart-line" style="color: #00a65a;"><span class="path1"></span><span class="path2"></span></i> Évolution Historique</h3>
                            </div>
                            <div class="card-body" style="padding: 20px;">
                                <div style="position: relative; height: 280px; width: 100%;">
                ...
                <div class="row" style="margin-top: 30px;">
                    <div class="col-md-12">
                        <label><i class="ki-duotone ki-message-text"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i> Observations générales :</label>
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-6">
                        <label><i class="ki-duotone ki-chart-line"><span class="path1"></span><span class="path2"></span></i> Plan d'amélioration :</label>
                    ...
                    <div class="col-md-6">
                        <label><i class="ki-duotone ki-star -o"></i> Appréciation VM :</label>
                ...
                <div class="alert-accomp">
                    <h4 style="margin-top: 0;"><i class="ki-duotone ki-information-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i> Nécessite un Accompagnement</h4>
...
<div class="fixed-score-footer btn-no-print">
    ...
    <div>
        <button onclick="window.print();" class="btn btn-primary btn-lg"><i class="ki-duotone ki-file -pdf-o"><span class="path1"></span><span class="path2"></span></i> EXPORTER LE RAPPORT</button>
    </div>
</div>
