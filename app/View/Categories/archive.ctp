...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><?php echo __('La liste des spécialités'); ?></h3>
        ...
        <table id="example1" class="table table-row-bordered table-row-gray-300 align-middle gy-4">
            ...
            <?php foreach ($categories as $categorie): ?>
                <tr>
                    ...
                    <td><?php echo $this->Html->link($categorie['Category']['name'], array('controller' => 'categories', 'action' => 'view', $categorie['Category']['id'])); ?></td>
                    <td><?php echo h($categorie['Category']['description']); ?>&nbsp;</td>
                    ...
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu" style="display:none;">
                                <li><?php echo $this->Html->link(__('Voir'), array('action' => 'view', $categorie['Category']['id'])); ?></li>
                                <li><?php echo $this->Html->link(__('Editer'), array('action' => 'edit', $categorie['Category']['id'])); ?></li>
                                <li><?php echo $this->Html->link(__('Désarchiver'), array('action' => 'archive', $categorie['Category']['id'], 1)); ?></li>
                            </ul>
                        </div>
                    </td>
                </tr>
