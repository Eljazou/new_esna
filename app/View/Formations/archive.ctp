        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <?php foreach ($formations as $formation): ?>
                <tr>
                    ...
                    <td><?php echo $this->Html->link($formation['Game']['name'], array('controller' => 'games', 'action' => 'view', $formation['Formation']['game_id'])); ?></td>
                    <td><?php echo h($formation['Formation']['name']); ?>&nbsp;</td>
                    <td><a target="_blank" href="/img/formations/<?php echo h($formation['Formation']['file']); ?>">Visualiser</a></td>
                    <td><?php echo h($formation['Formation']['created']); ?>&nbsp;</td>
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu" style="display:none;">
                                <?php echo '<li>' . $this->Html->link(__('Editer'), array('action' => 'edit', $formation['Formation']['id'])) . '</li>'; ?>
                                <?php echo '<li>' . $this->Html->link(__('Désarchiver'), array('action' => 'archive', $formation['Formation']['id'], 1)) . '</li>'; ?>
                            </ul>
                        </div>
                    </td>
                </tr>
