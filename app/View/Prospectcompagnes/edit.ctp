<style type="text/css">
    ...
    #edit-compagne-wrapper .form-group {
    ...
    #edit-compagne-wrapper .form-group label {
    ...
    #edit-compagne-wrapper .form-control {
        width: 100% !important;
    ...
    #edit-compagne-wrapper .form-control:focus {
    ...
    #edit-compagne-wrapper input[type="file"].form-control {
    ...
    #edit-compagne-wrapper .btn-outline-info,
    #edit-compagne-wrapper input[type="submit"] {
    ...
    #edit-compagne-wrapper .btn-outline-info:hover,
    #edit-compagne-wrapper input[type="submit"]:hover {
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-body payment-form">
                        ...
                        // Keeps ID track cleanly mapped internally
