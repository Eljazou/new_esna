...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><?php echo __('La liste des brochures'); ?></h3>
    ...
    <div class="card-body">
        <table id="example1" class="table table-row-bordered table-row-gray-300 align-middle gy-4">
            ...
            <?php foreach ($brochures as $brochure): ?>
                <tr>
                    <td><?php echo h($brochure['Brochure']['id']); ?>&nbsp;</td>
                    <td><?php echo $this->Html->link($brochure['Category']['name'], array('controller' => 'categories', 'action' => 'view', $brochure['Category']['id'])); ?></td>
                    <td><?php echo h($brochure['Brochure']['name']); ?>&nbsp;</td>
                    <td><?php echo h($brochure['Game']['name']); ?>&nbsp;</td>
                    <td><a href="/img/brochures/<?php echo $brochure['Brochure']['file']; ?>">Visualiser</a></td>
                    <td><?php echo h($brochure['Brochure']['created']); ?>&nbsp;</td>
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu" style="display:none;">
                                <li><?php echo $this->Html->link(__('Voir'), array('action' => 'view', $brochure['Brochure']['id'])); ?></li>
                                <li><?php echo $this->Html->link(__('Editer'), array('action' => 'edit', $brochure['Brochure']['id'])); ?></li>
                                <li><?php echo $this->Html->link(__('Désarchiver'), array('action' => 'archive', $brochure['Brochure']['id'], 1)); ?></li>
                            </ul>
                        </div>
                    </td>
                </tr>
