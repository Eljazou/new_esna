            ...
            <div class="col-12" style="height: 25px;">
                <div class="row">
                    ...
                    <div class="col-9" style=" padding: 0px;">
                        <p class="tile-pages">La liste des formations</p>
                    </div>
                    ...
                    <div class="ag-format-container">
                        <div class="ag-courses_box">
                            <div class="ag-courses_item">
                                <a href="<?php echo $this->Html->url("/img/formations/" . $d["Formation"]["file"]); ?>" class="ag-courses-item_link">
                                    <div class="ag-courses-item_bg"></div>
                                    <div class="ag-courses-item_title"><?php echo $d["Formation"]["name"] ?></div>
                                    <span class="ag-courses-item_date" style="float: right;">
                                        <?php echo $d["Game"]["name"]; ?>
