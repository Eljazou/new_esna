	...
	<header class="header header-fixed">
		<div class="header-content">
			<div class="left-content">
				<div class="media">
					...
					<h6 class="mb-0 font-13 title">👋 <?php echo $user_name; ?></h6>
				</div>
		...
		<?php if (count($visiteencour) != 0) : ?>
			...
			<div class="all-alert">
				...
				<a class="visite_url btn_spiner client_btn" href="<?php echo $this->Html->url(array("action" => "view_client", $code, $visiteencour["Client"]["id"])); ?>">

					<div class="container-card bg-white-box card-alert <?php echo $colorCard; ?>" id="<?php echo $visiteencour["Client"]["id"]; ?>">
						<div class="row">
					...
					<?php if (isset($visiteencour["Visite"]["id"])): ?>
						<?php echo $this->Form->postLink(
							...
							array(
								...
								$visiteencour["Visite"]["id"],
								$user_id
							),
							array(
								"class" => "btn_spiner btn btn-danger"
							)
						); ?>
					<?php endif; ?>
				</div>
						...
						<div class="row">
							...
							<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 7px 0px 10px;">
								<div class="card-home card-imag">
									<a href="<?php echo $this->Html->url(array("action" => "clients", $code)); ?>" class="btn_spiner t2">
							...
							<?php if ($user_role == "Super viseur") : ?>
								<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 10px 0px 7px;">
									<div class="card-home ">
										<a href="<?php echo $this->Html->url(array("action" => "valider_visite_double", $code)); ?>" class="btn_spiner t3">
											<span class="cercle cercle2"><i class="fa-regular fa-ballot-check"></i></span>
											<p class="title-card">Visites à valider</p>
							...
							<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 10px 0px 7px;">
								<div class="card-home ">
									<a href="<?php echo $this->Html->url(array("action" => "boite", $code)); ?>" class="btn_spiner t3">
							...
							if ($user_role == "Super viseur") :
								$cls_img = "card-imag";
								$style_color = "style='color: #7266d8;'";
								$t = "t2";
								$circle = "cercle1";
							else:
								$cls_img = "";
							...
							<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 7px 0px 10px;">
								<div class="card-home <?php echo $cls_img; ?>">
									<a href="javascript:void(0)" id="map_btn" class="btn_spiner <?php echo $t; ?>">

										<span class="cercle <?php echo $circle; ?>"><i class="fa-regular fa-location-dot" <?php echo $style_color; ?>></i></span>
							...
							<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 10px 0px 7px;">
								<div class="card-home card-imag">
									<a href="<?php echo $this->Html->url(array("action" => "brochure", $code)); ?>" class="btn_spiner t2">
							...
							<div class="col-6 mb-5" style="margin-bottom: 1rem!important;padding: 0px 10px 0px 7px;">
								<div class="card-home <?php echo $cls_img; ?>">
									<a href="<?php echo $this->Html->url(array("action" => "formations", $code)); ?>" class="btn_spiner <?php echo $t; ?>">

										<span class="cercle <?php echo $circle; ?>"><i class="fa-solid fa-info" <?php echo $style_color; ?>></i></span>
							...
							?>
							<div class="<?php echo $mycls; ?> mb-5" style="margin-bottom: 1rem!important;padding: 0px 7px 0px 10px;">
								<div class="card-home">
									<a href="<?php echo $this->Html->url(array("action" => "statistique", $code)); ?>" class="btn_spiner t3">
...
<script>
	...
	$('#main-content').css('top', headerHeight); // Set the top offset
	if (headerHeight < 80) {
		$('#main-content').css('height', `calc(100% - ${headerHeight + 10}px)`);
	}
	console.log(headerHeight);

	// $('#main-content').css('height', `calc(100% - ${headerHeight}px + 41px)`);
	...
	const sendToReactApp = (id) => {
		if (id) {
			const message = 'returnToApp_clientView_' + id;
			window.ReactNativeWebView.postMessage(message);
		} else {

			const message = 'returnToApp_map_url';
			window.ReactNativeWebView.postMessage(message);
		}
	};
</script>