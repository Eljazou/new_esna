...
<body>
          ...
          <div class="row" style="justify-content: center">
            <div class="container">
              ...
              <div class="image_welcome">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="177" height="115"
                  viewBox="0 0 613.35286 700.56123" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <path
    ...
    <div class=" all-elements">
      ...
      <div class="grid">
        ...
        ?>
          ...
          <div class="client_btn" id="<?php echo $client["Visite"]["id"]; ?>">
            <div class="row-list element-item">
              <div class="col-12">
                <div class="row">
                  ...
                  <div class="col-7 pl-0"><span
                      class="nom-client"><?php echo $client["Client"]["nom"] . " " . $client["Client"]["prenom"] ?></span>
                    <span class="nom-client"></span>
                  </div>
                  <div class="col col-pot "><span
                      class="pot-client  btn-green"><?php echo $client["Client"]["potentialite"] ?></span></div>
                </div>

                <div class="row row-region">
                  <div class="col-12 col-top">
                    <span class="type-client"><?php echo $client["User"]["name"]; ?></span>
                    <span class="type-client">Il y a <?php
                                                      //donne le temps de la visite en minute de la date de creation de la visite
                                                      echo round((time() - strtotime($client["Visite"]["created"])) / 60); ?> min</span>
                  </div>
                  <div class="col-2"></div>
                </div>
                <!-- div for content of the button for validation -->
                <div class="content-btn">
                  <!-- do modal button bootstrap 4 for confirmation -->
                  <button type="button" class="btn btn-valide" data-toggle="modal" data-target="#confirmationvalideModal" data-client-id="<?php echo $client["Visite"]["client_id"]; ?>" data-client-name="<?php echo $client["Client"]["nom"] . ' ' . $client["Client"]["prenom"]; ?>" data-visite-id="<?php echo $client["Visite"]["id"]; ?>">
                    Valider la visite
                  </button>

                  <!-- refuse button -->
                  <button type="button" class="btn btn-refuse" data-toggle="modal" data-target="#confirmationrefuseModal" data-client-id="<?php echo $client["Visite"]["client_id"]; ?>" data-client-name="<?php echo $client["Client"]["nom"] . ' ' . $client["Client"]["prenom"]; ?>" data-visite-id="<?php echo $client["Visite"]["id"]; ?>">
                    Refuser la visite
                  </button>
  ...
  <div class="modal fade" id="confirmationvalideModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content pop-content">
        <div class="modal-header pop-header">
          <h5 class="modal-title" style="color: #555361; font-family: 'Poppins', sans-serif;">
            Confirmation
          </h5>
          <button type="button" class="close" data-dismiss="modal">
            <span><i class="fa-light fa-xmark-large"></i></span>
          </button>
        </div>
        <div class="modal-body" style="text-align: center; padding: 20px;">
          <i class="fa-thin fa-circle-question" style="font-size: 60px; color: #6c63ff; margin-bottom: 15px; display: block;"></i>
          <p style="font-size: 16px; color: #555361; font-family: 'Poppins', sans-serif;">
            Voulez-vous valider la visite de <br>
            <strong id="modalClientName"></strong> ?
          </p>
        </div>
        <div class="modal-footer" style="justify-content: center; border-top: 0;">
          <button type="button" class="btn" data-dismiss="modal"
            style="background-color: #e0e0e0; color: #555361; border-radius: 8px; padding: 10px 30px; font-family: 'Poppins', sans-serif;">
            Annuler
          </button>
          <a id="btnOui" href="#" class="btn btn_spiner"
            style="background-color: #6c63ff; color: white; border-radius: 8px; padding: 10px 30px; font-family: 'Poppins', sans-serif;">
            Oui
          </a>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content pop-content">
        ...
        <div class="modal-body" style="text-align: center; padding: 20px;">
          <i class="fa-thin fa-circle-question" style="font-size: 60px; color: #6c63ff; margin-bottom: 15px; display: block;"></i>
          <p style="font-size: 16px; color: #555361; font-family: 'Poppins', sans-serif;">
            Voulez-vous refuser la visite de <br>
            <strong id="modalClientName"></strong> ?
          </p>
        </div>
        <div class="modal-footer" style="justify-content: center; border-top: 0;">
          ...
          <a id="btnRefuse" href="#" class="btn btn_spiner"
            style="background-color: #6c63ff; color: white; border-radius: 8px; padding: 10px 30px; font-family: 'Poppins', sans-serif;">
            Oui
          </a>
        </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#confirmationvalideModal').on('show.bs.modal', function(event) {
        ...
        // Show client name in modal
        $('#modalClientName').text(clientName);

        // Set the href for Oui button -> goes to validateDouble action
        $('#btnOui').attr('data-visite-id', visiteId);
        $('#btnOui').attr('data-client-id', clientId);
      });
      ...
      $('#confirmationrefuseModal').on('show.bs.modal', function(event) {
        ...
        // Set the href for Oui button -> goes to validateDouble action
        $('#btnRefuse').attr('data-visite-id', visiteId);
        $('#btnRefuse').attr('data-client-id', clientId);
      });


      $('#btnOui').on('click', function() {

        var visiteId = $(this).data('visite-id');
        sendToReactAppSetChezClient(visiteId + '||' + 1);
      ...
      $('#btnRefuse').on('click', function() {
        ...
        sendToReactAppSetChezClient(visiteId + '||' + 0);
