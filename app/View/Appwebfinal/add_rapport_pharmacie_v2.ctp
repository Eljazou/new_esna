...
<div class="all-elements">
    ...
    <div class="section-card">
        <h3 class="section-title"><i class="fa-solid fa-store"></i> Profil Pharmacie</h3>
    ...
    <div class="section-card">
        <h3 class="section-title"><i class="fa-solid fa-box-open"></i> Analyse par Produit</h3>
        <div id="analyse-container">
            <!-- JS Inject -->
        </div>
        <button type="button" class="btn-add" onclick="addAnalyse()"><i class="fa-solid fa-plus"></i> Ajouter un
            produit</button>
    </div>

    <!-- ========== III. CONCURRENCE ========== -->
    <div class="section-card">
        <h3 class="section-title"><i class="fa-solid fa-scale-unbalanced"></i> Concurrence</h3>
        <div class="field-group">
        ...
        <button type="button" id="btn-add-concurrent" class="btn-add" onclick="addConcurrent()"
            style="background:#ff7043; display: none;"><i class="fa-solid fa-plus"></i> Ajouter un concurrent</button>
    </div>
