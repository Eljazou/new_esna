<div class="card">
    <div class="card-header">
        <h3 class="card-title" style="padding-left: 0px;margin-left: -7px;"> <?php echo __('Ajouter une offre'); ?></h3>
    </div>
    <div class="card-body">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body payment-form">
                    ...
                    for($i=0;$i<10;$i++)
                    {
                        ...
                        echo $this->Form->input('produit_id', array('name'=>"data[$i][Offrespicial][produit_id]",'class' => 'form-control prod','div'=>array('class'=>'col-6','style'=>'padding: 0px;')));
                        echo $this->Form->input('quantite', array('name'=>"data[$i][Offrespicial][quantite]",'class' => 'form-control prodq','label'=>'Quantité','div'=>array('class'=>'col-3','style'=>'padding: 0px 4px;')));
                        echo $this->Form->input('reduction', array('name'=>"data[$i][Offrespicial][reduction]",'class' => 'form-control prodr','label'=>'Réduction','div'=>array('class'=>'col-3','style'=>'padding: 0px 3px;')));
						echo '</div>';
                    }?>
