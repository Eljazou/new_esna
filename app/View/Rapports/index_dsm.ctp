                ...
                <div class="col-md-10">
                    ...
                    <div class="col-md-5">
                        <select name="type_user" id="type_user" class="form-control">
                            ...
                            <option value="DSM" selected>DSM</option>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    ...
                    // Monday morning only (before 12:00)
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Moyenne de visite</th>
                            <th>Taux de couverture</th>
                            <th>Nombre de visites solo</th>
                            <th>En double</th>
                            <th>Commentaire</th>
                            <th>Activité terrain</th>
                            <th>Feed back matériel et produits</th>
                            <th>Activité de la concurrence</th>
                            <th>Commentaire</th>
                            <th class="actions"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $rapport['Rapport']['moyen_visite']; ?>
                                </td>
                                <td>
                                    <?php echo $rapport['Rapport']['taux_couverture'] ?>
                                </td>
                                <td>
                                    <?php echo $rapport['Rapport']['visite_solo']; ?>
                                </td>
                                <td>
                                    <?php echo $rapport['Rapport']['visite_double']; ?>
                                </td>
                                <td>
                                    <?php echo truncateText($rapport['Rapport']['commentaire_activite'], 20); ?>
                                </td>

                                <td>
                                    <?php echo $rapport['Rapport']['activite_terrain']; ?>
                                </td>
                                <td>
                                    <?php echo truncateText($rapport['Rapport']['Feed_terrain'], 20); ?>
                                </td>
                                <td>
                                    <?php echo $rapport['Rapport']['concurrence_terrain']; ?>
                                </td>
                                <td>
                                    <?php echo truncateText($rapport['Rapport']['commentaire_terrain'], 20); ?>
                                </td>
