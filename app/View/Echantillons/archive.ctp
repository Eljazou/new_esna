...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><?php echo __('Echantillons'); ?>
    ...
    <div class="card-body">
        <table id="example1" class="table table-row-bordered table-row-gray-300 align-middle gy-4">
            ...
            <?php foreach ($echantillons as $echantillon): ?>
                <tr>
                    <td><?php echo h($echantillon['Echantillon']['name']); ?>&nbsp;</td>
                    <td><?php echo h($echantillon['Game']['name']); ?>&nbsp;</td>
                    <td><?php echo h($echantillon['Echantillon']['created']); ?>&nbsp;</td>
                    <td class="actions">
                        <?php echo $this->Html->link(__('Désarchiver'), array('action' => 'archive', $echantillon['Echantillon']['id'], 1)); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
