...
@media (max-width:810px){
	.card-header.col-lg-8,.card-body .col-lg-8{
		width:100% !important;
	}
}
...
.concur .col-8{padding:0px;}
.concur .col-9{padding:0px;}
.concur .col-12 span.col-4{padding-left:0px;}
...
<div class="card">
    ...
    <!--<div class="col-lg-3 broch">
            <div class="info-box">
				<span class="symbol symbol-50px bg-primary d-flex align-items-center justify-content-center rounded"><i class="ki-duotone ki-text-bold fs-2 text-white"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>
        ...
        <div class="col-lg-8 col-12">
            <div class="card">
                <div class="card-body payment-form">
					...
					<div class="input text" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
						<label class="col-md-12 col-sm-12 col-12" style="padding:0;">
							<?php
					...
					<div class="input text" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
						<label class="col-md-12 col-sm-12 col-12" style="padding:0;">Adoption des produits Esnapharm <sup style="color:red;"></sup></label>
						<span class="col-md-4 col-sm-4 col-4">
					...
					<!--<div class="input text" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
						...
						// <?php
                            // echo $this->Form->input('produits', array('name' => "data[Visite][produits]", 'label' => 'La liste des produits partenaire', 'class' => 'col-md-12 col-sm-12 col-12 form-control select2 esna',"style"=>"padding:0px;"));
                            // ?>
                     </div>-->
					<div class="input text selectgame" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
						<?php 
							...
							?>
						<?php
							echo $this->Form->input('games', array('name' => "data[Visite][produits]", 'label' => $prod_label, 'class' => 'col-md-12 col-sm-12 col-12 form-control select2 produits', 'multiple' => "multiple","style"=>"padding:0px;"));
							
                        ?>
                    </div>
					<div class="input text" style="margin: 4px 0px;float: left;width: 100%;padding: 3px 6px;">
						<label class="col-md-12 col-sm-12 col-12" style="padding:0;"><?php echo $boit_label; ?></label>
						<span class="col-md-4 col-sm-4 col-4">
					...
					<div class="input text selectgame" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
					<?php echo $this->Form->input('games', array('name' => "data[Visite][produitsNP]", 'label' => $prodc_label, 'class' => 'col-md-12 col-sm-12 col-12 form-control select2 produits', 'multiple' => "multiple","style"=>"padding:0px;")); ?>
					</div>
					<div class="input text" style="margin: 4px 0px;float: left;width: 100%;padding: 3px 6px;">
						<label class="col-md-12 col-sm-12 col-12" style="padding:0;"><?php echo $boit_label; ?></label>
						<span class="col-md-4 col-sm-4 col-4">
					...
					<div class="input text" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
						<label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Noms des principaux prescripteurs</label>
						<?php
                            echo $this->Form->input('clientsSecteurs', array('name' => "data[Visite][prescripteurs]", 'label' => false, 'class' => 'col-md-12 col-sm-12 col-12 form-control select2 produits', 'multiple' => "multiple","style"=>"padding:0px;"));
                        ?>
                    </div>
									
					
					<div class="input text col-md-12 col-sm-12 col-12" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
                    <?php
                    ...
                    ?>
						...
						<div class="col-12" style="padding:0px;">
							<h4 class="col-12 bg-primary" style="border: 1px solid #aaa; border-top-right-radius: 4px; border-top-left-radius: 4px; padding: 5px 6px; margin-bottom: 0px;">
								...
								<span class="veilletogg" style="float:right;cursor:pointer;padding:4px;color:#074c75;" onclick="veille(0)"><i id="veilleicon0" class="ki-duotone ki-minus fs-4"></i></span>
							</h4>
							<div style="border:1px solid #aaa; border-bottom-right-radius:4px; border-bottom-left-radius:4px; padding:10px 0px; margin-top:0px; background:#fefefe;" class="col-12 veille0 concur">
								<div class="col-md-6 col-12">	
									<div class="col-md-12 col-12">
										<label class="col-12" style="padding: 0px;">Produit :</label>
									...
									<div class="col-md-12 col-12">
										<label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Emplacement produits :</label>
								...
								<div class="col-md-6 col-12">
									<div class="col-md-12 col-12">
										<label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Stocks disponibles au moment de la visite :</label>
										<input name="data[veillep][0][stock]" class="form-control" min="0" placeholder="Stock" type="number">
									</div>
									<div class="col-md-12 col-12">
										<label class="col-md-12 col-sm-12 col-12" style="padding:0px;">PLV en place :</label>
						...
						<div class="col-12 veille_div" style="margin-bottom:10px;padding:0px;" id="1">
						</div>
						<div class="col-12">
						...
						<div class="col-12" style="padding:0px;">
							<h4 class="col-12 bg-primary" style="border: 1px solid #aaa; border-top-right-radius: 4px; border-top-left-radius: 4px; padding: 5px 6px; margin-bottom: 0px;">
								...
								<span class="concurtogg" style="float:right;cursor:pointer;padding:4px;color:#074c75;" onclick="concur(0)"><i id="concuricon0" class="ki-duotone ki-minus fs-4"></i></span>
							</h4>
							<div style="border:1px solid #aaa; border-bottom-right-radius:4px; border-bottom-left-radius:4px; padding:10px 0px; margin-top:0px; background:#fefefe;" class="col-12 concur0 concur">
								<div class="col-md-6 col-12">	
									...
									<div class="col-md-12 col-12">
										<label class="col-12" style="padding: 0px;">Produit concurrent :</label>
										<input type="text" name="data[RapportConcurance][0][produit_concurant]" class="col-12" placeholder="Rédigez le nom du concurrent" style="float:left; padding:6px 8px;font-weight:bold;">
									</div>
									<div class="col-md-12 col-12">
										<label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Emplacement produits :</label>
								...
								<div class="col-md-6 col-12">
									...
									<div class="col-md-12 col-12">
										<label class="col-12" style="padding: 0px;margin-bottom: 11px;">Type de l’offre :</label>
										<div class="col-4">
									...
									<div class="col-md-12 col-12" style="margin-top: 11px;">
										<label class="col-12" style="padding: 0px;margin-bottom: 11px;">Degrés d’agressivité :</label>
										<div class="col-4">
						...
						<div class="col-12 concurr_pharm" style="margin-bottom:10px;padding:0px;" id="1">
						</div>
						<div class="col-12">
...
<script>
    /*$('document').ready(function(){
     var hgt = $('body').height();
     var popup = '<div class="col-md-12 popup" style="display:none;"><div id="image-gallery"><b onclick="$(\'.popup\').hide();" style="cursor:pointer;width: auto;height: auto;z-index: 999999;position: absolute;top:0;right:0;color: #fff;float: right;font-size: 30px;"><i class="ki-duotone ki-cross"><span class="path1"></span><span class="path2"></span></i></b><div class="image-container"></div><img src="/img/left.svg" class="prev"/><img src="/img/right.svg"  class="next"/><div class="footer-info"><span class="current"></span>/<span class="total"></span></div></div></div>'
     $('body').prepend(popup);
...
function veille(id){
	$(".veille"+id).toggle();
		...
		if(clas=='ki-duotone ki-minus fs-4'){
			$("#veilleicon"+id).attr("class", "ki-duotone ki-plus fs-4");
		}
		if(clas=='ki-duotone ki-plus fs-4'){
			$("#veilleicon"+id).attr("class", "ki-duotone ki-minus fs-4");
		}
}
...
$('.ajouterconcur_pharm').click(function(){
	...
	var ci = parseInt(cu);
	console.log(ci);
	var div = '<h4 class="col-12 bg-primary" style="border: 1px solid #aaa; border-top-right-radius:4px; border-top-left-radius: 4px; padding: 5px 6px; margin-bottom: 0px;"><b style="line-height: 27px;">Concurrence ('+(ci+1)+'):</b><span class="concurclose'+ci+'" style="float:right;cursor:pointer;padding:4px;color:#074c75;margin-left:5px;" onclick="concurcl('+ci+')"><i class="ki-duotone ki-cross"><span class="path1"></span><span class="path2"></span></i></span><span class="concurtogg" style="float:right;cursor:pointer;padding:4px;color:#074c75;" onclick="concur('+ci+')"><i id="concuricon'+ci+'" class="ki-duotone ki-minus fs-4"></i></span></h4><div style="border:1px solid #aaa; border-bottom-right-radius:4px; border-bottom-left-radius:4px; padding:10px 0px;margin-top:0px;background:#fefefe;" class="col-12 concur'+ci+' concur"><div class="col-md-6 col-12"><div class="col-md-12 col-12"><label class="col-12" style="padding: 0px;">Produit :</label><select name="data[RapportConcurance]['+ci+'][produit_id]" class="form-control select2 prodc"><option value="">Choisissez</option><?php foreach ($games as $k=>$v):?><option value="<?php echo $k ; ?>"><?php echo $v ; ?></option><?php endforeach ; ?></select></div><div class="col-md-12 col-12"><label class="col-12" style="padding: 0px;">Produit concurrent :</label><input type="text" name="data[RapportConcurance]['+ci+'][produit_concurant]" class="col-12" placeholder="Rédigez le nom du concurrent" style="float:left; padding:6px 8px;font-weight:bold;"></div><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Emplacement produits :</label><select name="data[RapportConcurance]['+ci+'][emplacement]" class="col-md-12 form-control" style="padding:0px;text-transform: capitalize;"><option value="">Choisissez</option><option value="Etageres">étagères</option><option value="Presentoirs">présentoirs</option><option value="Absent">Absent</option></select></div><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Stocks disponibles au moment de la visite :</label><input name="data[RapportConcurance]['+ci+'][stock]" class="form-control" min="0" placeholder="Stock" type="number"></div></div><div class="col-md-6 col-12"><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">PLV en place :</label><select name="data[RapportConcurance]['+ci+'][plv]" class="col-md-12 form-control" style="padding:0px;text-transform: capitalize;"><option value="">Choisissez</option><option value="Panneau">Panneau</option><option value="Affiche">Affiche</option></select></div><div class="col-md-12 col-12"><label class="col-12" style="padding: 0px;margin-bottom: 11px;">Type de l’offre :</label><div class="col-4"><input type="checkbox" name="data[RapportConcurance]['+ci+'][type_offre][]" value="Pack"><b> Pack</b></div><div class="col-4"><input type="checkbox" name="data[RapportConcurance]['+ci+'][type_offre][]" value="Action"><b> Action</b></div><div class="col-4"><input type="checkbox" name="data[RapportConcurance]['+ci+'][type_offre][]" value="Autres"><b> Autres</b></div> </div><div class="col-md-12 col-12" style="margin-top: 11px;"><label class="col-12" style="padding: 0px;margin-bottom: 11px;">Degrés d’agressivité :</label><div class="col-4"><input type="radio" name="data[RapportConcurance]['+ci+'][agressivite][]" value="Tres agressive"><b> Très agressive</b></div><div class="col-4"><input type="radio" name="data[RapportConcurance]['+ci+'][agressivite][]" value="Agressive"><b> Agressive</b></div><div class="col-4"><input type="radio" name="data[RapportConcurance]['+ci+'][agressivite][]" value="Peu agressive"><b> Peu agressive</b></div></div></div></div>';
...
$('.ajouter_veille').click(function(){
	...
	var ci = parseInt(cu);
	console.log(ci);
	var div = '<h4 class="col-12 bg-primary" style="border: 1px solid #aaa; border-top-right-radius:4px; border-top-left-radius: 4px; padding: 5px 6px; margin-bottom: 0px;"><b style="line-height: 27px;">Veille ('+(ci+1)+'):</b><span class="veilleclose'+ci+'" style="float:right;cursor:pointer;padding:4px;color:#074c75;margin-left:5px;" onclick="veillecl('+ci+')"><i class="ki-duotone ki-cross"><span class="path1"></span><span class="path2"></span></i></span><span class="veilletogg" style="float:right;cursor:pointer;padding:4px;color:#074c75;" onclick="veille('+ci+')"><i id="veilleicon'+ci+'" class="ki-duotone ki-minus fs-4"></i></span></h4><div style="border:1px solid #aaa; border-bottom-right-radius:4px; border-bottom-left-radius:4px; padding:10px 0px;margin-top:0px;background:#fefefe;" class="col-12 veille'+ci+' concur"><div class="col-md-6 col-12"><div class="col-md-12 col-12"><label class="col-12" style="padding: 0px;">Produit :</label><select name="data[veillep]['+ci+'][produit_id]" class="form-control select2 prodv"><option value="">Choisissez</option><?php foreach ($games as $k=>$v):?><option value="<?php echo $k ; ?>"><?php echo $v ; ?></option><?php endforeach ; ?></select></div><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Emplacement produits :</label><select name="data[veillep]['+ci+'][emplacement]" class="col-md-12 form-control" style="padding:0px;text-transform: capitalize;"><option value="">Choisissez</option><option value="Etageres">étagères</option><option value="Presentoirs">présentoirs</option><option value="Absent">Absent</option></select></div></div><div class="col-md-6 col-12"><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">Stocks disponibles au moment de la visite :</label><input name="data[veillep]['+ci+'][stock]" class="form-control" min="0" placeholder="Stock" type="number"></div><div class="col-md-12 col-12"><label class="col-md-12 col-sm-12 col-12" style="padding:0px;">PLV en place :</label><select name="data[veillep]['+ci+'][plv]" class="col-md-12 form-control" style="padding:0px;text-transform: capitalize;"><option value="">Choisissez</option><option value="Panneau">Panneau</option><option value="Affiche">Affiche</option></select></div></div></div>';
