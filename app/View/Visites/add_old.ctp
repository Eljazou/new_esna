                ...
                <div class="col-lg-12 col-xs-12">
                    <div class="panel panel-primary">
                        <div class="box-body no-padding  form-horizontal payment-form">
                            ...
                            ?>
                            <div style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                                <?php
                                echo "<div class='box-header with-border'>
                            <h4 class='box-title'>Date de visite </h4></div>";
                                echo $this->Form->input('date', ['type' => 'text', 'class' => 'box-body no-padding form-control', 'style' => 'border: 1px solid #d6d6d6;padding-left: 5px;border-radius: 6px;', 'label' => false, 'id' => 'datepicker']);
                                ?>
                            </div>
                            <?php
                            if ($infosclient[0]['clients']['type_id'] == 1 || $infosclient[0]['clients']['type_id'] == 5) {
                            ?>
                                ...
                                <div class="input text selectgame" style="margin: 4px 0px;float: left;width: 100%;border-top: 3px solid #eee;padding: 3px 6px;border-radius:5px;">
                                    ...
                                    <?php
                                    echo $this->Form->input('games', array('name' => "data[Visite][produits]", 'label' => false, 'class' => 'col-md-12 col-sm-12 col-xs-12 form-control select2 produits', 'multiple' => "multiple", "style" => "padding:0px;","required"=>"required"));
                                    ?>
                                </div>
                                ...
                                <div class="input text" style="margin: 4px 0px;float: left;width: 100%;padding: 3px 6px;">
                                    <label class="col-md-12 col-sm-12 col-xs-12" style="padding:0;">Potentialité produit renseigné</label>
                            ...
                            <?php } else { ?>
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <div class="input text selectgame box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                                        <?php
                                        echo "<div class='box-header with-border'><h4 class='box-title'>Adoption produit </h4></div>";
                                        ...
                                        ?>
                                        <div class="box-header with-border">
                                            <h4 class="box-title col-md-12 col-sm-12 col-xs-12" style="padding:0;">Potentialité produit </h4>
                                        </div>
                                        <div class="for-pad">
                                            <span class="col-md-4 col-sm-4 col-xs-4 text-center">
                                                <input type="radio" name="data[Visite][produitschoix]" class="boits" value="1" style="float:left;width: 17px;height: 16px;margin-top: 3px;margin-left: 2px;" disabled><b style="font-weight:normal;"> 1 </b>
                                            </span>
                                            <span class="col-md-4 col-sm-4 col-xs-4 text-center">
                                                <input type="radio" name="data[Visite][produitschoix]" class="boits" value="2" style="float:left;width: 17px;height: 16px;margin-top: 3px;margin-left: 2px;" disabled><b style="font-weight:normal;"> 2 </b>
                                            </span>
                                            <span class="col-md-4 col-sm-4 col-xs-4 text-center ">
                                                <input type="radio" name="data[Visite][produitschoix]" class="boits" value="3" style="float:left;width: 17px;height: 16px;margin-top: 3px;margin-left: 2px;" disabled><b style="font-weight:normal;"> 3 </b>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <h4 class='box-title'>Noms des principaux prescripteurs </h4></div>";
                                    ...
                                    <?php for ($i = 0; $i < 2; $i++) : ?>
                                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                                            <label class="col-xs-12 " style="border-bottom: 1px solid #ecf0f5; border-top-right-radius: 4px; border-top-left-radius: 4px; padding: 5px 6px; margin-bottom: 0px;margin-top:5px;">
                                                <b style="line-height: 27px;">Veille <?php echo $i + 1; ?> :</b>
                                                <span class="concurtogg" style="float:right;cursor:pointer;padding:4px;color:#aaa;" onclick="concur(<?php echo $i ?>)"><i id="concuricon<?php echo $i ?>" class="fa fa-minus"></i></span>
                                            </label>
                                            <div style="  padding: 10px 0px; margin-top: 0px; display: block;" class="col-xs-12 concur<?php echo $i ?> concure">
                                                ...
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <?php echo $this->Form->input("Visite.objection.$i.stock", array("label" => false, 'placeholder' => "Stock disponible au moment de la visite", "type" => "number", "style" => "margin-top:2px;")); ?>
                                                </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="input text box box-primary" style="border: 1px solid #3c8dbc; border-radius: 6px; padding: 7px;margin-top: 6px;">
                                            <label class="col-xs-12" style="border-bottom: 1px solid #ecf0f5; padding: 5px 6px; margin-bottom: 0px;margin-top:5px;">
                                                <b style="line-height: 27px;">Concurance <?php echo $i - 1; ?> : </b>
                                            ...
                                            <div style="padding: 10px 0px; margin-top: 0px; display: block;" class="col-xs-12 concur<?php echo $i ?> concure">
                                                ...
                                                <span class="col-md-6 col-sm-4 col-xs-4 check0">
                                                    <?php echo $this->Form->input("Visite.concurrence_p.$i.produitconcurant", array("label" => false, 'placeholder' => "Produit concurant", "style" => "width:95%")); ?>
                                                </span>
                                                <div class="col-md-12" style="margin-top: 14px;">
                                                    <div class="col-md-6 col-sm-8 col-xs-8" style="padding-left: 0;">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 14px;">
                                                ...
                                                <div class="col-md-12" style="padding-top: 14px;">
                                                    ...
                                                    <span class="col-md-8 col-sm-8 col-xs-8" style="padding-left: 18px;">
                                                        <span class="col-md-4 col-sm-4 col-xs-4">
                                                        ...
                                                        <span class="col-md-4 col-sm-4 col-xs-4" style="padding-left: 37px;">
                                                        ...
                                                        <span class="col-md-4 col-sm-4 col-xs-4" style="padding-left: 60px;">
                                    ...
                                    <?php endfor; ?>
                                    <div class="input text col-md-12 col-sm-12 col-xs-12" id="stockv" style="position: relative;padding:0px;">
                                        <ul class="tabs" style="margin-bottom:17px;border: 1px solid #3c8dbc;border-radius: 6px;padding: 7px;margin-top: 6px;">
                                            ...
                                            <li><?php echo $this->Form->input("Stockvisite.0.commentaire", array('label' => 'Commentaire', 'class' => 'form-control', 'style' => "width: 280px;")); ?></li>
                                        </ul>
