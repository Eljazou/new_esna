            ...
            <div class="card-body">
                ...
                <div class="mb-5">
                    <div class="date_div">
                        ...
                        <i class="ki-duotone ki-calendar-8 icon_calendar"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></i>
                    </div>
                </div>
                ...
                ?>
                    ...
                    <div class="mb-5" id="stockv">
                        <ul class="tabs">
                            ...
                            <li class="col-12"><button type="button" id="add" class="btn btn-success btn-large"><i class="ki-duotone ki-plus"></i></button></li>
                        </ul>
